...
EXTENSION_ENTRY(dyn_glGetProgramResourceIndex, ptr_glGetProgramResourceIndex, "glGetProgramResourceIndex", glGetProgramResourceIndex, GLuint -> GLenum -> Ptr GLchar -> IO GLuint)
